  ...
  static List<QuizQuestion> _getQuestions(AppLocalizations loc) {
    return [
      QuizQuestion(
        ...
        answers: [loc.answer1_1, loc.answer1_2, loc.answer1_3, loc.answer1_4],
        correctAnswer: 0,
      ),
      QuizQuestion(
        question: loc.question2,
        answers: [loc.answer2_1, loc.answer2_2, loc.answer2_3, loc.answer2_4],
        correctAnswer: 0,
      ),
      QuizQuestion(
        question: loc.question3,
        answers: [loc.answer3_1, loc.answer3_2, loc.answer3_3, loc.answer3_4],
        correctAnswer: 0,
      ),
      QuizQuestion(
        question: loc.question4,
        answers: [loc.answer4_1, loc.answer4_2, loc.answer4_3, loc.answer4_4],
        correctAnswer: 0,
      ),
      QuizQuestion(
        question: loc.question5,
        answers: [loc.answer5_1, loc.answer5_2, loc.answer5_3, loc.answer5_4],
        correctAnswer: 0,
      ),
      QuizQuestion(
        question: loc.question6,
        answers: [loc.answer6_1, loc.answer6_2, loc.answer6_3, loc.answer6_4],
        correctAnswer: 0,
      ),
    ];
  }
